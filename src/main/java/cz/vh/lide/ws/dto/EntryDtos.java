...
public final class EntryDtos {
  ...
  public record EntryCreate(String type, String title, String content, Instant occurredAt,
  ...
  public record EntryUpdate(String type, String title, String content, Instant occurredAt) {
  }
}
