...
import type { MediaFormValue } from "./MediaForm";

export const validateMediaForm = (value: MediaFormValue) => {
  return !value.mediaType.trim() || !value.uri.trim();
};

type MediaFormNewProps = {
...
export function MediaForm_new({
  ...
  return (
    <div className="space-y-3">
      ...
      {showSubmitButton && (
        <Button
          disabled={disabled || validateMediaForm(value)}
          onClick={onSubmit}
        >
          {submitLabel}
        </Button>
